...
Public Class peajar_ulang_akademik_view
    ...
    Private Function ValidateForm() As Boolean
        ...
        If ddlKodKursus.SelectedValue = "" Then
            lblMsg.Text = "Sila pilih Kod Kursus."
            ddlNamaKelas.Focus()
            Return False
        End If

        If ddlNamaKelas.SelectedValue = "" Then
    ...
    Protected Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        If PB3.Checked = True Then
            ...
            strSQL = "SELECT PelajarID FROM kpmkv_pelajar_ulang WHERE  PelajarID='" & Request.QueryString("PelajarID") & "' AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaMataPelajaran='MATHEMATIC' AND PB IS NOT NULL"
            If oCommon.isExist(strSQL) = True Then
                divMsg.Attributes("class") = "error"
                lblMsg.Text = "Calon ini telah mengulang bagi Matapelajaran MATHEMATIC"
                Exit Sub
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaMataPelajaran, PB, MarkahPA)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "','" & ddlNamaKelas.SelectedValue & "','MATHEMATIC','1','" & strA_Mathematics & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PA3.Checked = True Then
            ...
            strSQL = "SELECT PelajarID FROM kpmkv_pelajar_ulang WHERE  PelajarID='" & Request.QueryString("PelajarID") & "' AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaMataPelajaran='MATHEMATIC' AND PA IS NOT NULL "
            If oCommon.isExist(strSQL) = True Then
                divMsg.Attributes("class") = "error"
                lblMsg.Text = "Calon ini telah mengulang bagi Matapelajaran MATHEMATIC"
                Exit Sub
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaMataPelajaran,PA, MarkahPB)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "','" & ddlNamaKelas.SelectedValue & "','MATHEMATIC','1','" & strB_Mathematics & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'MAT------------------------------------------------------------------------------------------------------------------------------------
        ...
        If PB4.Checked = True Then
            ...
            strSQL = "SELECT PelajarID FROM kpmkv_pelajar_ulang WHERE  PelajarID='" & Request.QueryString("PelajarID") & "' AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaMataPelajaran='SCIENCE' AND PB IS NOT NULL"
            If oCommon.isExist(strSQL) = True Then
                divMsg.Attributes("class") = "error"
                lblMsg.Text = "Calon ini telah mengulang bagi Matapelajaran SCIENCE"
                Exit Sub
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaMataPelajaran, PB, MarkahPA)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "','" & ddlNamaKelas.SelectedValue & "','SCIENCE','1','" & strA_MarkahSC2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PA4.Checked = True Then
            ...
            strSQL = "SELECT PelajarID FROM kpmkv_pelajar_ulang WHERE  PelajarID='" & Request.QueryString("PelajarID") & "' AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaMataPelajaran='SCIENCE' AND PA IS NOT NULL"
            If oCommon.isExist(strSQL) = True Then
                divMsg.Attributes("class") = "error"
                lblMsg.Text = "Calon ini telah mengulang bagi Matapelajaran SCIENCE"
                Exit Sub
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaMataPelajaran, PA,MarkahPB)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "','" & ddlNamaKelas.SelectedValue & "','SCIENCE','1', '" & strB_Science1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'SCIENCE---------------------------------------------------------------------
