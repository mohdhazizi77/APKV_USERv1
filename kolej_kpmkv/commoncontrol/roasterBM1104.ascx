<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="roasterBM1104.ascx.vb" Inherits="kpmkv.roasterBM1104" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td>
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Roster BM setara" CssClass="fbbutton"
