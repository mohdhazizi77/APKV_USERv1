<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="akademik_setara.ascx.vb" Inherits="kpmkv.akademik_setara" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran>> Akademik Setara >>Pendaftaran Calon</td>
    </tr>
</table>
<br />
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran Calon Akademik</td>
    </tr>
     <tr>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Calon Akademik.</td>
    </tr>
    <tr>
        <td colspan="2">
     ...
     <tr>
        <td colspan="2">
        <asp:Button ID="btnConfirm" runat="server"  CssClass="fbbutton" OnClick = "OnConfirm" Text = "Pengesahan Pendaftaran Calon" OnClientClick = "Confirm()" Width="369px"/>
    </tr>
    </table>
<br />
