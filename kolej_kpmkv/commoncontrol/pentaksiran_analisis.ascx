<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksiran_analisis.ascx.vb" Inherits="kpmkv.pentaksiran_analisis" %>
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="SJ" >
                     ...
                     <asp:TemplateField HeaderText="PA" >
                        <ItemTemplate>
                            <asp:Label ID="A_Sejarah" runat="server" Text='<%# Bind("A_Sejarah")%>'></asp:Label>
                        </ItemTemplate>
                           <HeaderStyle HorizontalAlign="Left"/>
                          <ItemStyle  HorizontalAlign="Left" />
                    </asp:TemplateField>
