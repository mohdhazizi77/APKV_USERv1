...
Public Class pelajar_ulang_vokasional_view
    ...
    Protected Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        If PB1.Checked = True Then
            ...
            strSQL = "SELECT PelajarUlangVID FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarID='" & Request.QueryString("PelajarID") & "'"
            strSQL += " AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaModul='" & lblModul1.Text & "'"
            Dim strVID = oCommon.getFieldValue(strSQL)
            If oCommon.isExist(strSQL) = True Then

                strSQL = "SELECT PBTeori FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlangVID='" & strVID & "'"
                Dim PbTeori1 As String = oCommon.getFieldValue(strSQL)
                If PbTeori1 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori1 & "' "
                    strSQL += " WHERE PelajarUlangVID='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)

                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul ='" & lblModul1.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, "
                strSQL += " Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1', '" & A_Teori1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB9.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                strSQL = "SELECT PBAmali FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlangVID='" & strVID & "'"
                Dim PbAmali1 As String = oCommon.getFieldValue(strSQL)
                If PbAmali1 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali1 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul1.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                strSQL += " Sesi, KursusID, KelasID, NamaModul, PBAmali, MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & A_Amali1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm1------------------------------------------------------------------
        ...
        If PB2.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBTeori2 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori2 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul='" & lblModul2.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                strSQL += " Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & A_Teori2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB10.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali2 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali2 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul2.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & A_Amali2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm2-----------------------------------
        ...
        If PB3.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBTeori3 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori3 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul ='" & lblModul3.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & A_Teori3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB11.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali3 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali3 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul3.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & A_Amali3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm3-------------------------------------------------------
        ...
        If PB4.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBTeori4 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori4 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul ='" & lblModul4.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & A_Teori4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB12.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali4 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali4 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul4.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & A_Amali4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm4-----------------------------------------------------------
        ...
        If PB5.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                strSQL = "SELECT PBTeori FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlangID='" & strVID & "'"
                Dim PBTeori5 As String = oCommon.getFieldValue(strSQL)
                If PBTeori5 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori5 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul='" & lblModul5.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & A_Teori5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB13.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali5 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali5 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul5.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & A_Amali5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm5------------------------------------------------------
        ...
        If PB6.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBTeori6 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori6 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul='" & lblModul6.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & A_Teori6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB14.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali6 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali6 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblModul6.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & A_Amali6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm6-------------------------------------------------------------------------
        ...
        If PB7.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBTeori7 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBTeori='1', MarkahPATeori='" & A_Teori7 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBTeori bagi NamaModul='" & lblmodul7.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & A_Teori7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB15.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PBAmali7 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PBAmali='1', MarkahPAAmali='" & A_Amali7 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PBAmali bagi NamaModul='" & lblmodul7.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & A_Amali7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm7------------------------------------------------------------------------------------
        ...
        If PA1.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                strSQL = "SELECT PATeori FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlangVID='" & strVID & "' "
                Dim PATeori1 As String = oCommon.getFieldValue(strSQL)
                If PATeori1 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori1 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul1.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                strSQL += " Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += "'" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & B_Teori1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA2.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori2 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori2 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul2.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & B_Teori2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA3.Checked = True Then
            ...
            End If
            '--------------------------
            strSQL = "SELECT PelajarUlangVID FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarID='" & Request.QueryString("PelajarID") & "' AND KolejRecordID='" & lblKolejID.Text & "'"
            strSQL += " AND NamaModul='" & lblModul3.Text & "'"
            Dim strVID = oCommon.getFieldValue(strSQL)
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori3 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori3 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul3.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & B_Teori3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA4.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori4 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori4 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul4.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & B_Teori4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA5.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori5 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori5 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul5.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, "
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & B_Teori5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA6.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori6 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori6 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblModul6.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & B_Teori6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA7.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PATeori7 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PATeori='1', MarkahPBTeori='" & B_Teori7 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PATeori bagi NamaModul='" & lblmodul7.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, "
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & B_Teori7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PA9.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                strSQL = "SELECT PAAmali FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlangVID='" & strVID & "'"
                Dim PAAmali1 As String = oCommon.getFieldValue(strSQL)
                If PAAmali1 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali1 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul1.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                strSQL += " Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & B_Amali1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA10.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PAAmali2 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali2 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul2.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & B_Amali2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA11.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PAAmali3 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali3 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul3.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & B_Amali3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA12.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PAAmali4 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali4 & "' "
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul4.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & B_Amali4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA13.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PAAmali5 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali5 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul5.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & B_Amali5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA14.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                strSQL = "SELECT PAAmali FROM kpmkv_pelajar_ulang_vokasional WHERE  PelajarUlagVID='" & strVID & "'"
                Dim PAAmali6 As String = oCommon.getFieldValue(strSQL)
                If PAAmali6 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali6 & "'"
                    strSQL += " WHERE PelajarUlangVID ='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblModul6.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & B_Amali6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA15.Checked = True Then
            ...
            If oCommon.isExist(strSQL) = True Then
                ...
                If PAAmali7 = "" Then
                    strSQL = "UPDATE kpmkv_pelajar_ulang_vokasional SET PAAmali='1', MarkahPBAmali='" & B_Amali7 & "'"
                    strSQL += " WHERE PelajarUlangVID='" & strVID & "'"
                    strRet = oCommon.ExecuteSQL(strSQL)
                Else
                    divMsg.Attributes("class") = "error"
                    lblMsg.Text = "Calon ini telah mengulang PAAmali bagi NamaModul='" & lblmodul7.Text & "'"
                    Exit Sub
                End If
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester,"
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "',"
                strSQL += " '" & ddlTahun.Text & "','" & ddlSemester.Text & "','" & chkSesi.Text & "','" & ddlKodKursus.Text & "',"
                strSQL += " '" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & B_Amali7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If lblMsg.Text = "" Then
            ...
            lblMsg.Text = "Daftar Calon Ulang Vokasional Berjaya!"
            'Modul_Nama()
            'Hidden()
            'HiddenPBPACheckBox()
        End If
