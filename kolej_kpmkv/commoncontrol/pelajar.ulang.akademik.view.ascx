...
<table class="fbform">
    ...
    <tr>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB1" runat="server" Enabled ="false"  /></td>
    ...
    <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB2" runat="server" Enabled ="false" /></td>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB3" runat="server" Enabled ="false" /></td>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB4" runat="server" Enabled ="false" /></td>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB5" runat="server" Enabled ="false" /></td>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB6" runat="server" Enabled ="false" /></td>
     ...
     <tr>
         ...
         <td style="width: 10%; text-align: center;"><asp:CheckBox ID="PB7" runat="server" Enabled ="false" /></td>
