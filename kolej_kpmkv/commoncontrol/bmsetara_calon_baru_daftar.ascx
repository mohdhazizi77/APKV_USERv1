<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="bmsetara_calon_baru_daftar.ascx.vb" Inherits="kpmkv.bmsetara_calon_baru_daftar" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran>> BM Setara >>Calon Baru</td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">BM Setara Calon Baru</td>
    </tr>
    <tr>
