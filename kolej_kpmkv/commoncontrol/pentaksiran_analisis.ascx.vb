...
Public Class pentaksiran_analisis
    ...
    Private Function getSQL() As String
        ...
        '--not deleted
        tmpSQL = "SELECT kpmkv_pelajar.PelajarID, kpmkv_pelajar.Nama,kpmkv_pelajar.AngkaGiliran, kpmkv_pelajar.Mykad,"
        ...
        tmpSQL += " kpmkv_pelajar_markah.GredV1,B_Amali1,B_Teori1, A_Amali1,A_Teori1,"
        tmpSQL += " kpmkv_pelajar_markah.GredV2, B_Amali2,B_Teori2, A_Amali2,A_Teori2,"
        tmpSQL += " kpmkv_pelajar_markah.GredV3, B_Amali3,B_Teori3, A_Amali3,A_Teori3,"
        tmpSQL += " kpmkv_pelajar_markah.GredV4, B_Amali4,B_Teori4, A_Amali4,A_Teori4,"
        tmpSQL += " kpmkv_pelajar_markah.GredV5, B_Amali5,B_Teori5, A_Amali5,A_Teori5,"
        tmpSQL += " kpmkv_pelajar_markah.GredV6, B_Amali6,B_Teori6, A_Amali6,A_Teori6,"
        tmpSQL += " kpmkv_pelajar_markah.GredV7, B_Amali7,B_Teori7, A_Amali7,A_Teori7,"
        tmpSQL += " kpmkv_pelajar_markah.GredV8, B_Amali8,B_Teori8, A_Amali8,A_Teori8,"
