...
<table class="fbform">
    ...
    <tr>
        <td style="width: 80px;">
         ...
         <td>
            :<asp:TextBox ID="txtLoginID" runat="server" Text="" Width="200px" MaxLength="50" AutoComplete="OFF"></asp:TextBox>&nbsp;*<br />
    ...
    <tr>
         ...
         <td>
            :<asp:TextBox ID="txtPwd" runat="server" TextMode="Password" Width="200px" MaxLength="50" AutoComplete="OFF"></asp:TextBox>&nbsp;*<br />
