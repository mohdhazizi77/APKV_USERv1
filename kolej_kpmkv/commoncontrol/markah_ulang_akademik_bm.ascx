<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_ulang_akademik_bm.ascx.vb" Inherits="kpmkv.markah_ulang_akademik_bm" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Markah Ulang Akademik Bahasa Melayu</td>
    </tr>
     <tr>
     ...
     <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlSemester" runat="server" AutoPostBack="false" Width="350px" Enabled ="false">
...
<asp:Label ID="lblMsgTop" runat="server" Text="Sistem Mesej..."></asp:Label>
</div>
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Calon
